...
//const Processo = require("../../backend/src/processo/Processo");
...
defineFeature(feature, (test) => {
    ...
    const filePatch = "http://127.0.0.1:5500/frontend/index.html" //usando o liveserver
  ...
  /*  test("Consulta de processo do histórico", ({ given, and, when, then }) =>{
        ...
        then("a página deve ser a de histórico", async (numeroDoProcesso) => {
            const title = await page.title();
    ...
    */
    ...
    test("Acesso a tela do histórico", ({ given, and, when, then }) =>{
        ...
        and('clica no botão de voltar', async() => {
